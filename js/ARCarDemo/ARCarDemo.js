    ...
    return (
      <ViroARScene>
        ...
        <ViroARImageMarker target={"logo"} onAnchorFound={this._onAnchorFound} pauseUpdates={this.state.pauseUpdates}>
          ...
          {/* <Viro3DObject
            scale={[0, 0, 0]}
            source={require('./res/Truck/model.obj')}
            resources={[require('./res/Truck/materials.mtl'),
                        ]}
            type="OBJ"
          ...
          <Viro3DObject
            scale={[0, 0, 0]}
            source={require('./res/Coyote/Coyote.obj')}
            resources={[require('./res/Coyote/Coyote.mtl'),
                        ]}
            type="OBJ"
            materials={["coyote"]}
            // onClick={this._toggleButtons}
...
ViroMaterials.createMaterials({
  coyote: {
    lightingModel: "PBR",
    diffuseTexture: require('./res/Coyote/Coyote_BaseColor.png'),
    shininess: 0.5
  },
  blue: {
    lightingModel: "PBR",
...
ViroARTrackingTargets.createTargets({
  logo : {
    source : require('./res/coyote3.png'),
    orientation : "Up",
